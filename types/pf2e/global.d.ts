...
import { default as Hotbar } from "../foundry/client/applications/ui/hotbar.mts";
import { default as Config } from "../foundry/client/config.mts";
import { default as WallDocument } from "../foundry/client/documents/wall.mts";
import { FoundryUI } from "../foundry/client/ui.mts";
import { CompendiumUUID } from "../foundry/client/utils/_module.mts";
import { ImageFilePath, RollMode, UserRole } from "../foundry/common/constants.mts";
...
interface ClientSettingsPF2e extends fh.ClientSettings {
    get(module: "core", key: "compendiumConfiguration"): Record<string, {
        private: boolean;
        locked: boolean;
    }>;
