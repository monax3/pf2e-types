...
import { HandlebarsApplicationMixin_base } from "../../../../../foundry/client/applications/api/handlebars-application.mts";
...
export declare function TokenConfigMixinPF2e<TMixin extends AbstractConstructorOf<fa.api.ApplicationV2 & HandlebarsApplicationMixin_base> & Omit<typeof fa.api.ApplicationV2 & typeof HandlebarsApplicationMixin_base, "prototype">>(Base: TMixin): AbstractMixin<TMixin, TokenConfigMixin_base & HandlebarsApplicationMixin_base, typeof TokenConfigMixin_base & HandlebarsApplicationMixin_base & fa.api.ApplicationV2>;
