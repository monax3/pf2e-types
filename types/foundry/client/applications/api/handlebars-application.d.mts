import { ApplicationFormConfiguration, ApplicationRenderContext, ApplicationRenderOptions } from '../_types.mjs';
...
export default function HandlebarsApplicationMixin<T extends AbstractConstructorOf<ApplicationV2>>(BaseApplication: T): AbstractMixin<T, HandlebarsApplicationMixin_base, typeof HandlebarsApplicationMixin_base & typeof ApplicationV2>;
